...
import CriarDesenhos from '../CriarDesenhos';
...
function NavigationDrawer(props) {
    ...
    const drawer = (
        <div>
            ...
            <Divider />
            <List>
                {['Início', 'Criar Desenhos', 'Desenhos'].map((text, index) => (
    ...
    return (
        <div className={classes.root}>
            ...
            <main className={classes.content}>
                <div className={classes.toolbar} />
                {
                    indexGlobal == 0  ? <Inicio /> : 
                    indexGlobal == 1  ? <CriarDesenhos /> :
                    indexGlobal == 2  ? <Desenhos /> :
                    null
                }
            </main>
        </div>
